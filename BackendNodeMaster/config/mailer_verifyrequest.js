...
module.exports =async(content,sub,to,account,attachment_files,logfilename="/home/ubuntu/logs/default.log", recordid) => {
    ...
    if(account['isoffice365']==undefined || account['isoffice365']==null || account['isoffice365']==0)
    {
        ...
        try{
            ...
            let updatesql= format(`UPDATE verifyrequest SET status=true  WHERE id=${recordid}`);
